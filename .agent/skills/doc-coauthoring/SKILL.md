...
1. **优化与结构化**：通过头脑风暴和编辑迭代地构建每个章节
1. **读者测试**：用一个全新的 Claude（无上下文）测试文档，在他人阅读之前发现盲点
...
1. 主要受众是谁？
1. 当别人阅读这份文档时，期望产生什么影响？
1. 是否有要遵循的模板或特定格式？
1. 还有其他需要了解的约束条件或上下文吗？
...
1. 粘贴或分享文档内容（如果使用启用了连接器的共享文档平台，提供链接）
1. 向读者 Claude 询问生成的问题
