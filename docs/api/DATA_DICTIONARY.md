...
| `is_production` | Boolean | INDEX | 否 | False | 是否为生产环境部署 |
...
| `description` | String | - | 是 | - | - |
| `state` | String | INDEX | 是 | - | - |
| `is_draft` | Boolean | - | 否 | False | 是否为草稿状态 |
...
| `rubber_stamp` | Boolean | - | 否 | False | 是否被判定为秒批 (Rubber-stamping) |
| `author_id` | UUID | FK | 是 | - | - |
| `created_by` | UUID | FK, INDEX | 是 | - | 创建者ID |
| `updated_by` | UUID | FK, INDEX | 是 | - | 最后操作者ID |
| `source_system` | String(50) | INDEX | 是 | - | 数据来源系统标识 |
