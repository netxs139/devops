...
try:
    ...
    if not cost_df.empty:
        ...
        with c1:
            ...
            fig_pie = px.pie(cost_df, values="estimated_monthly_cost_cny", names="product_id", hole=0.3)
    ...
    if not cleanup_df.empty:
        ...
        with o1:
            ...
            fig_bar = px.bar(
                ...
                y="数量",
                color="危险等级",
                color_discrete_map={"CRITICAL_DELETE": "#FF4B4B", "WARNING_CLEANUP": "#FFA500", "KEEP_SAFE": "#2EB82E"},
            )
        ...
        with o2:
            ...
            st.dataframe(
                danger_list[["component_name", "component_version", "size_gb", "cleanup_priority_level", "cleanup_reasons_text"]], use_container_width=True
            )
